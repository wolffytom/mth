...
% 设定文档的基本信息。
\pkuthssinfo{
	cthesisname = {硕士研究生开题报告}, ethesisname = {},
	ctitle = {基于像素级处理技术的视频目标跟踪算法研究}, etitle = {},
	cauthor = {崔家梁},
	eauthor = {Cui Jialiang},
	studentid = {1601210300},
	date = {2018年6月},
	school = {地球与空间科学学院},
	cmajor = {摄影测量与遥感}, emajor = {Some Major},
	direction = {数字摄影测量与遥感数字成像},
	cmentor = {赵红颖\ 副教授}, ementor = {Prof.\ Somebody},
	ckeywords = {视频，目标跟踪，像素级别}, ekeywords = {First, Second}
}
